...
let muscleGroups: [MuscleGroup] = [
    ...
    MuscleGroup(
        ...
        exerciseDetails: [
            ...
            "Leg extensions": "Les leg extensions sont un exercice ciblant principalement les quadriceps, réalisés sur une machine spécifique. Vous êtes assis sur la machine, vos pieds placés sous des coussinets. En tendant vos jambes, vous soulevez une charge, puis vous contrôlez la descente.Cet exercice permet d’isoler efficacement les quadriceps, en se concentrant sur leur contraction et leur étirement. Il est particulièrement utile pour renforcer la partie avant des cuisses, améliorer la définition musculaire et augmenter la force des quadriceps. Bien qu’il soit très efficace pour le développement musculaire, il doit être réalisé avec une technique correcte pour éviter les tensions sur les genoux."
        ]
    ),
    MuscleGroup(
        name: "Ischio",
